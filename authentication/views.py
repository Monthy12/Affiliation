...
from .forms import Contact_Person
...
def signup_user(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and profile_form.is_valid():
            ...
            # sendSms(233205668745,"Thank you for creating an account with us. Kindly use your login details to begin the process.")
